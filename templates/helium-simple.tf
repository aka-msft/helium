...
module "service_plan" {
  source                  = "github.com/microsoft/cobalt/tree/master/infra/modules/providers/azure/service-plan"
  resource_group_name     = "${azurerm_resource_group.helium_resource.name}"
  resource_group_location = "${azurerm_resource_group.helium_resource.location}"
  service_plan_name       = "${var.service_plan_name}"
}

module "app_insights" {
  source                               = "github.com/microsoft/cobalt/tree/master/infra/modules/providers/azure/app-insights"
...
module "cosmosdb" {
    source                             = "github.com/microsoft/cobalt/tree/master/infra/modules/providers/azure/cosmosdb"
    service_plan_resource_group_name   = "${azurerm_resource_group.helium_resource.name}"
